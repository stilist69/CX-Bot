...
QUESTIONS = {
    ...
    "likar": [
        ...
        {"q":"Що ви робите, якщо пацієнт нервує?","options":["A. Продовжую працювати — час дорогоцінний.","B. Роблю паузу, пояснюю, що буде далі.","C. Прошу адміністратора заспокоїти."],"correct":"B"},
        {"q":"Як ви передаєте інформацію адміністратору після прийому?","options":["A. Усно, коли є час.","B. Через нотатку або у CRM.","C. Не передаю — він сам знає."],"correct":"B"},
        {"q":"Що ви робите, якщо пацієнт відмовляється від лікування?","options":["A. Пропоную дешевший варіант.","B. Запитую, що саме викликає сумнів.","C. Просто записую відмову."],"correct":"B"},
    ...
    "admin": [
        ...
        {"q":"Якщо лікар затримується — що ви робите?","options":["A. Кажу «чекайте».","B. Повідомляю, скільки часу орієнтовно чекати, і пропоную воду/каву.","C. Не пояснюю, бо це не моя зона відповідальності."],"correct":"B"},
        ...
        {"q":"Як завершуєте розмову по телефону?","options":["A. «До побачення.»","B. «Гарного дня, чекаємо вас.»","C. Без нічого — просто кладу слухавку."],"correct":"B"}
    ]
}
...
persistence = PicklePersistence(filepath="cxbot_state.pickle")
